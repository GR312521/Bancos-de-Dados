fetch('dados.json').then(resposta => resposta.json()).then(banco => {
    ...
    document.getElementById('cliente').innerHTML = banco[4].clientes.client001
    ...
    document.getElementById('cliente2').innerHTML = banco[4].clientes.client002
    ...
    document.getElementById('cliente3').innerHTML = banco[4].clientes.client003
    ...
    document.getElementById('cliente4').innerHTML = banco[4].clientes.client004
    ...
    document.getElementById('cliente5').innerHTML = banco[4].clientes.client005
})